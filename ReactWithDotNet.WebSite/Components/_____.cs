    ...
    protected override Element render()
    {
        return
          ...
          new div(BackgroundColor("rgb(255, 255, 255)"), BackgroundImage("None"), BorderBottom("1px solid"), BorderColor("rgb(229, 234, 242)"), BorderImageOutset(0), BorderImageRepeat("Stretch"), BorderImageSlice("100%"), BorderImageSource("None"), BorderImageWidth(1), BorderLeft("1px solid"), BorderRadius(12), BorderRight("1px solid"), BorderTop("1px solid"), BoxSizingBorderBox, BreakInside("Avoid"), Color("rgb(28, 32, 37)"), DisplayBlock, Height(364), MarginBottom(16), Padding(16), Transition("border 0.15s cubic-bezier(0.4, 0, 0.2, 1) 0s, box-shadow 0.15s cubic-bezier(0.4, 0, 0.2, 1) 0s"))
          {
              ...
              {
                  new svg(svg.Focusable("False"),  ViewBox("0 0 24 24"), Data("testid", "AcUnitIcon"), BoxSizingBorderBox, Color("rgb(0, 127, 255)"), DisplayBlock, Fill("rgb(0, 127, 255)"), FlexShrink(0), FontSize20, Height(20), Transition("fill 0.2s cubic-bezier(0.4, 0, 0.2, 1) 0s"), UserSelect("None"), Width("1em"))
                  {
                  ...
                  new h3(BoxSizingBorderBox, Color("rgb(28, 32, 37)"), FontFamily("'IBM Plex Sans', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'"), FontSize14, FontWeight700, LetterSpacingNormal, LineHeight21)
                  {
                      "Perpetual license model"
                  }
              },
              new div(BoxSizingBorderBox, Color("rgb(67, 77, 91)"), FontFamily("'IBM Plex Sans', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'"), FontSize14, FontWeight400, LetterSpacingNormal, LineHeight21, Margin(0))
              {
