        ...
        protected override Element render()
        {
            return new Tooltip
            {
                ...
                children =
                {
                    ...
                    {
                        IsRunning
                            ? new LoadingIcon { Color = Theme.Blue700 } + Size(size / 2, size / 2)
                            : new svg(svg.ViewBox(0, 0, size, size), svg.Fill(Theme.Blue400), Size(size / 2, size / 2), Hover(Fill(Theme.Blue700)))
                            {
