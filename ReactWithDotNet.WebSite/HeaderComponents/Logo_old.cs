...
public class Logo_old : PureComponent
{
...
public class Logo : PureComponent
{
    protected override Element render()
    {
        return new a(Href("/"), TextDecorationNone, Color(inherit), Size(32,32))
        {
            new svg(Width("30"), Height("32"), ViewBox("0 0 36 32"), Fill("none"))
            {
                new path
                {
                    fillRule = "evenodd",
