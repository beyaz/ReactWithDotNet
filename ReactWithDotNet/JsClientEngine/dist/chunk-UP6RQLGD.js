...
var TextareaAutosize = /* @__PURE__ */ React.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  const {
    onChange,
    maxRows,
    minRows = 1,
...
var InputBase = /* @__PURE__ */ React2.forwardRef(function InputBase2(inProps, ref) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(React2.Fragment, {
    children: [!disableInjectingGlobalStyles && typeof InputGlobalStyles === "function" && // For Emotion/Styled-components, InputGlobalStyles will be a function
    // For Pigment CSS, this has no effect because the InputGlobalStyles will be null.
    (_InputGlobalStyles || (_InputGlobalStyles = /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(InputGlobalStyles, {}))), /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(Root, {
      ...rootProps,
      ref,
      onClick: handleClick,
      ...other,
