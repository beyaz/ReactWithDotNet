  ...
  class NewPureComponent extends import_react.default.PureComponent {
    render() {
      if (this.props.$styles) {
        if (DynamicStyles[this.props.$jsonNode[DotNetComponentUniqueIdentifier]] !== this.props.$styles) {
          DynamicStyles[this.props.$jsonNode[DotNetComponentUniqueIdentifier]] = this.props.$styles;
