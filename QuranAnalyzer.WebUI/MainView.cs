...
namespace QuranAnalyzer.WebUI
{
    ...
    class MainView : ReactComponent<MainViewModel>
    {
        public override Element render()
        {
            ...
            topNav = new nav { style = { margin = "20px", display = Display.flex, justifyContent = JustifyContent.space_between, alignItems = AlignItems.center }, }.HasBorder()
                + (new svg { viewBox = "0 0 100 100", style = { height = "40px" } }
