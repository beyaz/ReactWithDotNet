...
Tahminim o ki burada şeytanın bir oyunu olabilir. 19 meselesini sulandırarak, alakasız konularla ilişkilendirerek 19 gibi basit anlaşılır bir meseleyi anlaşılmaz işin içindne çıkılmaz ve şüpheli bir hale getirmeye çalışıyor olabilir."
            },
            ...
            new p
            {
                @"Elbetteki madalyonun diğer yüzünde 19 olayını daha tarafsız inceleyen KuranMucizeler.com, Gürkan Engin gibi isimler de var.
...
"
      ...
      Dilerseniz bu sitede kullanılan sayım programlarını kullanabilir ve alternatif iddaları inceleyebilirsiniz."
            }
        };
    }
}