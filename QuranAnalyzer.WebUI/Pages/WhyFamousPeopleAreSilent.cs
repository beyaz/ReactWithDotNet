    ...
    protected override Element render()
    {
        return new Article
        {
            ...
            new p
            {
                ...
                "Tüm medyatik din adamlarının tek amacı insanları sömürürmektir gibi saçma bir cümle elbet kurmayacağım. ",
                ...
                "Yaradan bu kitapda ne diyor deyip de bir tercüme okuyan sayısı oldukça az. Burada çuvaldızı kendime batırmakdan da gocunmuyorum." +
